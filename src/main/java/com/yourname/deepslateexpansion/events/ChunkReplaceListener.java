...
public class ChunkReplaceListener {
    ...
    public static void onChunkLoad(ChunkDataEvent.Load event) {
        ...
        // TODO: Add ore replacements when you identify the wrong IDs they map to
    }

    private static void replaceWrongBlock(Chunk chunk, Block wrongBlock, Block correctBlock) {
        int minY = -64;
        int maxY = 319;
        for (int x = 0; x < 16; x++) {
            for (int z = 0; z < 16; z++) {
